...
class MSTypingProvider : MSChatBaseProvider() {
    ...
    override fun setData(
            ...
            .subscribe(object : ResourceObserver<Long>() {
                ...
                override fun onComplete() {
                    for (i in getAdapter()!!.data.indices.reversed()) {
                        if (getAdapter()!!.data[i].msMsg.type == MSContentType.typing) {
        ...
        contentTvLayout.setAll(bgType, from, MSContentType.typing)
