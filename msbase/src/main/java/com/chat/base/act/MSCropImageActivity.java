 ...
 * 剪切图片
 */
public class MSCropImageActivity extends MSBaseActivity<ActCutImgLayoutBinding> {
    ...
    protected void rightLayoutClick() {
        ...
        Bitmap bitmap = msVBinding.cropImageView.getCroppedImage();
        if (bitmap != null) {
    ...
    protected void rightLeftLayoutClick() {
        ...
        rotate = rotate + 90;
        msVBinding.cropImageView.rotateImage(rotate);
    }
    ...
    protected void initView() {
        ...
        if (!TextUtils.isEmpty(path)) {
            ...
            msVBinding.cropImageView.setImageBitmap(bitmap);
        }
    }
}
