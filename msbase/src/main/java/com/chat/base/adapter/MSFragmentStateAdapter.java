...
public class MSFragmentStateAdapter extends FragmentStateAdapter {
    List<Fragment> fragmentList;
    private final List<Long> fragmentIds = new ArrayList<>();
    private final HashSet<Long> createIds = new HashSet<>();

    public MSFragmentStateAdapter(@NonNull FragmentManager fragmentManager, Lifecycle lifecycle, List<Fragment> fragmentList) {
        super(fragmentManager, lifecycle);
        setFragmentList(fragmentList);
    }

    public MSFragmentStateAdapter(@NonNull FragmentActivity fragmentActivity, List<Fragment> fragmentList) {
