...
public class Theme {
    ...
    public static final String ms_theme_pref = "ms_theme_pref";
    ...
    public static void applyTheme() {
        String themePref =
                MSSharedPreferencesUtil.getInstance().getSP(Theme.ms_theme_pref, Theme.DEFAULT_MODE);
        Theme.applyTheme(themePref);
    }

    public static String getTheme() {
        return MSSharedPreferencesUtil.getInstance().getSP(Theme.ms_theme_pref, Theme.DEFAULT_MODE);
    }

    public static void setTheme(String s) {
        MSSharedPreferencesUtil.getInstance().putSP(Theme.ms_theme_pref, s);
        Theme.applyTheme(s);
    }
    ...
    public static int getSwitchViewTrackColor() {
        String ms_theme_pref = MSSharedPreferencesUtil.getInstance().getSP(Theme.ms_theme_pref, Theme.DEFAULT_MODE);
        if (ms_theme_pref.equals(DARK_MODE)) {
            return 0xFF585858;
        } else
    ...
    public static boolean isDark() {
        String ms_theme_pref = MSSharedPreferencesUtil.getInstance().getSP(Theme.ms_theme_pref, Theme.DEFAULT_MODE);
        return ms_theme_pref.equals(DARK_MODE);
    }
    ...
    public static Drawable getTicksSingleDrawable() {
        if (ticksSingleDrawable == null) {
            RLottieDrawable drawable = new RLottieDrawable(MSBaseApplication.getInstance().getContext(), R.raw.ticks_single, "ticks_single", AndroidUtilities.dp(22), AndroidUtilities.dp(22));
    ...
    public static Drawable getTicksDoubleDrawable() {
        if (ticksDoubleDrawable == null) {
            RLottieDrawable drawable = new RLottieDrawable(MSBaseApplication.getInstance().getContext(), R.raw.ticks_double, "ticks_double", AndroidUtilities.dp(22), AndroidUtilities.dp(22));
            drawable.setCurrentFrame(drawable.getFramesCount() - 1);
