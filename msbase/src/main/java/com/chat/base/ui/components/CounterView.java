...
//                    this.textColor = textColor;
                textPaint.setColor(ContextCompat.getColor(MSBaseApplication.getInstance().getContext(), textColor));
//                }
//                if (circlePaint != null && this.circleColor != circleColor) {
//                    this.circleColor = circleColor;
                circlePaint.setColor(ContextCompat.getColor(MSBaseApplication.getInstance().getContext(), circleColor));
//                }
            }
