...
//                }
        ...
        public void setupGradient(String colorKey, float alpha) {
            int color = ContextCompat.getColor(MSBaseApplication.getInstance().getContext(), R.color.homeColor); //Theme.getColor(colorKey);
    ...
    public static Bitmap getBitmap(int res, int width, int height, int color, float scale) {
        try (InputStream stream = MSBaseApplication.getInstance().getContext().getResources().openRawResource(res)) {
    ...
    public static SvgDrawable getDrawable(int resId, int color) {
        try {
            ...
            xr.setContentHandler(handler);
            xr.parse(new InputSource(MSBaseApplication.getInstance().getContext().getResources().openRawResource(resId)));
            return handler.getDrawable();
        } catch (Exception e) {
            return null;
        }
