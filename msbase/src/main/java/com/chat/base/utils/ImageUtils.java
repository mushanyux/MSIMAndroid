...
public class ImageUtils {
    ...
    public void saveBitmap(Context context, Bitmap bitmap, boolean isRefresh, ISave iSave) {
        ...
        File file = new File(MSConstants.imageDir, fileName);
        try {
    ...
    public String getNewestPhoto() {
        ...
        try {
            ...
            cursor = MSBaseApplication.getInstance().getContext().getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, new String[]{MediaStore.Images.Media._ID, MediaStore.Images.Media.DATA},
