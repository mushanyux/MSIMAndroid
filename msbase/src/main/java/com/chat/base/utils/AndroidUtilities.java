...
public class AndroidUtilities {
    ...
    public static void setDensity(float density1) {
        density = density1;
        Resources resources = MSBaseApplication.getInstance().getContext().getResources();
    ...
    public static void cancelRunOnUIThread(Runnable runnable) {
        if (MSBaseApplication.applicationHandler == null) {
            return;
        }
        MSBaseApplication.applicationHandler.removeCallbacks(runnable);
    }
    ...
    public static void runOnUIThread(Runnable runnable, long delay) {
        ...
        if (delay == 0) {
            MSBaseApplication.applicationHandler.post(runnable);
        } else {
            MSBaseApplication.applicationHandler.postDelayed(runnable, delay);
        }
    }
            ...
            if (!typefaceCache.containsKey(assetPath)) {
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= 26) {
                        Typeface.Builder builder = new Typeface.Builder(MSBaseApplication.getInstance().getContext().getAssets(), assetPath);
                        ...
                        t = Typeface.createFromAsset(MSBaseApplication.getInstance().getContext().getAssets(), assetPath);
                    }
