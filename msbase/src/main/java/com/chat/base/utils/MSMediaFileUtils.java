...
public class MSMediaFileUtils {
    private MSMediaFileUtils() {
    }

    private static class MediaFileUtilsBinder {
        final static MSMediaFileUtils fileUtils = new MSMediaFileUtils();
    }

    public static MSMediaFileUtils getInstance() {
    ...
    public String getVideoCover(String videoPath) {
        ...
        return MSFileUtils.getInstance().saveBitmap(null, bitmap);
    }
