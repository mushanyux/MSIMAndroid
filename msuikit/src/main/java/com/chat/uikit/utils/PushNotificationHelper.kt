...
object PushNotificationHelper {
    ...
    private val MESSAGE = NotificationCompatUtil.Channel(
        channelId = MSConstants.newMsgChannelID,
        name = MSBaseApplication.getInstance().context.getString(R.string.new_msg_notification),
        importance = NotificationManager.IMPORTANCE_DEFAULT,
        sound = Uri.parse("android.resource://" + MSBaseApplication.getInstance().context.packageName + "/" + R.raw.newmsg)
    )
    ...
    private val CALL = NotificationCompatUtil.Channel(
        channelId = MSConstants.newRTCChannelID,
        name = MSBaseApplication.getInstance().context.getString(R.string.new_rtc_notification),
        importance = NotificationManager.IMPORTANCE_HIGH,
        lockScreenVisibility = NotificationCompat.VISIBILITY_PUBLIC,
        vibrate = longArrayOf(0, 4000, 2000, 4000),
        sound = Uri.parse("android.resource://" + MSBaseApplication.getInstance().context.packageName + "/" + R.raw.newrtc)
    )
