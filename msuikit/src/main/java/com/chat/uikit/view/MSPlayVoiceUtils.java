...
public class MSPlayVoiceUtils {
    private MSPlayVoiceUtils() {

    }

    private static class PlayVoiceUtilsBinder {
        static MSPlayVoiceUtils playVoiceUtils = new MSPlayVoiceUtils();
    }

    public static MSPlayVoiceUtils getInstance() {
