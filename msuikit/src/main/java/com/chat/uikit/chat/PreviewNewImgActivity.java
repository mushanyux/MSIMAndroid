 ...
 * 预览新图片
 */
public class PreviewNewImgActivity extends MSBaseActivity<ActPreviewNewImgLayoutBinding> {
    private String path;
    ...
    protected void initView() {
        ...
        GlideUtils.getInstance().showImg(this, path, msVBinding.imageView);
    }
