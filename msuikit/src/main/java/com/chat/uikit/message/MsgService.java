...
public interface MsgService {
    ...
    Observable<MSSyncChat> syncChat(@Body JSONObject jsonObject);

    @POST("message/channel/sync")
    Observable<MSSyncChannelMsg> syncChannelMsg(@Body JSONObject jsonObject);

    @POST("message/extra/sync")
    Observable<List<MSSyncExtraMsg>> syncExtraMsg(@Body JSONObject jsonObject);
    ...
    Observable<List<MSSyncReminder>> syncReminder(@Body JSONObject jsonObject);
    ...
    Observable<List<MSSyncConvMsgExtra>> syncCoverExtra(@Body JSONObject jsonObject);
