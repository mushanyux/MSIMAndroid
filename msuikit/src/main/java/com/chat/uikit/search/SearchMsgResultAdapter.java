 ...
 * 搜索消息结果
 */
public class SearchMsgResultAdapter extends BaseQuickAdapter<MSMsg, BaseViewHolder> {
    private String searchKey;

    public SearchMsgResultAdapter(String searchKey, @Nullable List<MSMsg> data) {
        super(R.layout.item_search_msg_result_layout, data);
        this.searchKey = searchKey;
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, MSMsg msg) {
        ...
        //消息时间
        baseViewHolder.setText(R.id.timeTv, MSTimeUtils.getInstance().getTimeString(msg.timestamp * 1000));
