...
//
//class FlexTabActivity : MSBaseActivity<ActFlexTabLayoutBinding>() {
...
//            msVBinding.bottomView.addView(
//                item.itemTab,
//                LayoutHelper.createLinear(0, LayoutHelper.WRAP_CONTENT, 1f, Gravity.CENTER)
//            )
//            fragments.add(item.fragment)
//        }
//        msVBinding.vp.adapter = MSFragmentStateAdapter(this, fragments)
//        msVBinding.vp.registerOnPageChangeCallback(object : OnPageChangeCallback() {
